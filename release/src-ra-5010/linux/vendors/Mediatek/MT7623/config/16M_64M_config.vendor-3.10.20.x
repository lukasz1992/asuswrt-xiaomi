...
CONFIG_USER_SAMBA=y
# CONFIG_SAMBA_3_0_2 is not set
# CONFIG_SAMBA_3_6_6 is not set
CONFIG_SAMBA_4_0_24=y
...
# Bluetooth-apps
#
CONFIG_USER_BLUEANGEL=y
CONFIG_USER_BLUEANGEL_MTKBT=y
CONFIG_USER_BLUEANGEL_BTCLI=y
# CONFIG_USER_BTCLI_ON is not set
# CONFIG_USER_BLUEANGEL_RPLAYER is not set
# CONFIG_USER_BLUEANGEL_BTAGENT is not set
# CONFIG_USER_BLUEANGEL_BTSNK is not set
CONFIG_USER_BLUEANGEL_RELAYER=y
CONFIG_USER_BLUEANGEL_AUTOBT=y
# CONFIG_USER_ROUTER_PLAYER_2_0 is not set
...
# CONFIG_USER_IXIA_ENDPOINT_670 is not set
