...
# CONFIG_MTK_NFC_MT6605_SIM is not set
...
# CONFIG_AMAZON_METRICS_LOG is not set
CONFIG_SYNC=y
CONFIG_SW_SYNC=y
...
# CONFIG_MTK_OVERLAY_ENGINE_SUPPORT
...
# CONFIG_MTK_FB_SUPPORT_ASSERTION_LAYER is not set
...
CONFIG_RAETH_QDMA=y
# CONFIG_RAETH_QDMATX_QDMARX is not set
...
# CONFIG_WSC_NFC_SUPPORT is not set
...
# CONFIG_ED_MONITOR_SUPPORT is not set
...
# CONFIG_SINGLE_SKU_V2 is not set
...
# CONFIG_ENHANCE_NEW_MBSSID_MODE is not set
...
# CONFIG_MCAST_RATE_SPECIFIC is not set
...
# CONFIG_MT_DOT11_VHT_AC is not set
CONFIG_MT_DOT11W_PMF_SUPPORT=y
# CONFIG_MT_TXBF_SUPPORT is not set
CONFIG_MT_LLTD_SUPPORT=y
# CONFIG_MT_QOS_DLS_SUPPORT is not set
# CONFIG_MT_WAPI_SUPPORT is not set
# CONFIG_MT_CARRIER_DETECTION_SUPPORT is not set
CONFIG_MT_IGMP_SNOOP_SUPPORT=y
# CONFIG_MT_BLOCK_NET_IF is not set
CONFIG_MT_RATE_ADAPTION=y
CONFIG_MT_NEW_RATE_ADAPT_SUPPORT=y
# CONFIG_MT_AGS_SUPPORT is not set
# CONFIG_MT_IDS_SUPPORT is not set
# CONFIG_MT_WIFI_WORK_QUEUE is not set
# CONFIG_MT_WIFI_SKB_RECYCLE is not set
# CONFIG_MT_RTMP_FLASH_SUPPORT is not set
# CONFIG_MT_BTCOEX_CONCURRENT is not set
# CONFIG_MT_LED_CONTROL_SUPPORT is not set
# CONFIG_MT_SINGLE_SKU_V2 is not set
CONFIG_MT_ATE_SUPPORT=y
CONFIG_MT_RT2860V2_AP_V24_DATA_STRUCTURE=y
# CONFIG_MT_MEMORY_OPTIMIZATION is not set
# CONFIG_MT_HOTSPOT is not set
# CONFIG_MT_HOTSPOT_R2 is not set
# CONFIG_MT_RTMP_TEMPERATURE_TX_ALC is not set
CONFIG_MT_UAPSD=y
CONFIG_MT_IPA_ILNA=y
# CONFIG_MT_IPA_ELNA is not set
# CONFIG_MT_EPA_ILNA is not set
# CONFIG_MT_EPA_ELNA is not set
...
#CONFIG_MT_MAC_REPEATER_SUPPORT is not set
# CONFIG_MT_MULTI_APCLI_SUPPORT is not set
# CONFIG_MT_DFS_SUPPORT is not set
# CONFIG_MT_DOT11R_FT_SUPPORT is not set
# CONFIG_MT_NINTENDO_AP is not set
# CONFIG_MT_COC_SUPPORT is not set
# CONFIG_MT_MCAST_RATE_SPECIFIC is not set
# CONFIG_MT_PREVENT_ARP_SPOOFING_SUPPORT is not set
