...
#if defined(CONFIG_MODEL_RTAC85U) || defined(CONFIG_MODEL_RTAC65U) || defined(CONFIG_MODEL_RTN800HP)	//ASUS_EXT
...
{
#if defined (CONFIG_MODEL_RTAC85U) || defined(CONFIG_MODEL_RTAC65U) || defined(CONFIG_MODEL_RTN800HP) 	//only initialize at boot time.
 	   if(!first_gsw_init) 
		first_gsw_init=1;
