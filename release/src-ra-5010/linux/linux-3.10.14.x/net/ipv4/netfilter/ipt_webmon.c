...
static int __init init(void)
{
...
#ifdef CONFIG_PROC_FS
	{
		...
		struct proc_dir_entry *proc_webmon_recent_domains = proc_create_data("webmon_recent_domains", 0, NULL, &webmon_proc_domain_fops, NULL);
		struct proc_dir_entry *proc_webmon_recent_searches = proc_create_data("webmon_recent_searches", 0, NULL, &webmon_proc_search_fops, NULL);
#else
