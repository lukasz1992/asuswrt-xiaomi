...
#else
#define CFG_NVRAM_SIZE		0x0
#if defined(DUAL_TRX)
#define CFG_FIRMWARE_SIZE	(50 * 1024 * 1024) 	//50 MB
#endif
#endif

#if defined(CFG_ENV_IS_IN_NAND) && !defined(MTK_NAND)
...
#if defined(DUAL_TRX)
#define CFG_BOOTLOADER_SIZE	(CFG_BLOCKSIZE * 7)	// 7 blocks (892 KB)
#define CFG_CONFIG_SIZE		(CFG_BLOCKSIZE * 8)	// 8 blocks (1 MB)
#define CFG_FACTORY_SIZE	(CFG_BLOCKSIZE * 8)	// 8 blocks (1 MB)
#define CFG_FACTORY2_SIZE	(CFG_BLOCKSIZE * 8)	// 8 blocks (1 MB)
#else
#define CFG_BOOTLOADER_SIZE	(CFG_BLOCKSIZE<<2)
#define CFG_CONFIG_SIZE		(CFG_BLOCKSIZE<<2)
#define CFG_FACTORY_SIZE	(CFG_BLOCKSIZE<<1)
#define CFG_FACTORY2_SIZE	0
#endif
#define CFG_MAX_BOOTLOADER_BINARY_SIZE	CFG_BOOTLOADER_SIZE
#else
...
#define CFG_FACTORY2_ADDR	(CFG_FLASH_BASE + CFG_BOOTLOADER_SIZE + CFG_CONFIG_SIZE + CFG_NVRAM_SIZE + CFG_FACTORY2_SIZE)
#define CFG_KERN_ADDR		(CFG_FLASH_BASE + (CFG_BOOTLOADER_SIZE + CFG_CONFIG_SIZE + CFG_NVRAM_SIZE + CFG_FACTORY_SIZE + CFG_FACTORY2_SIZE))
#if defined(UBI_SUPPORT)
...
#define CFG_KERN2_ADDR		(CFG_FLASH_BASE + (CFG_BOOTLOADER_SIZE + CFG_CONFIG_SIZE + CFG_NVRAM_SIZE + CFG_FACTORY_SIZE + CFG_FACTORY2_SIZE + CFG_FIRMWARE_SIZE))
#endif /* UBI_SUPPORT */
#else
#define CFG_ENV_ADDR		(CFG_FLASH_BASE + CFG_BOOTLOADER_SIZE)
