...
/// NOTE by Vic: SDK 4.1.0.0 expand dram_header size, but it is not used in current SoC
#if 0
#if defined (MT7620_ASIC_BOARD) || defined (MT7620_FPGA_BOARD) || defined (MT7621_ASIC_BOARD) || defined (MT7621_FPGA_BOARD)
#define IH_NMLEN		(16-4*2)	/* Image Name Length		*/
#elif defined (RT6855A_ASIC_BOARD) || defined (RT6855A_FPGA_BOARD)
#define IH_NMLEN		(16-4*4)
#else
...
#if defined(CONFIG_ASUS_PRODUCT) && defined(ON_BOARD_SPI_FLASH_COMPONENT)
	union {
