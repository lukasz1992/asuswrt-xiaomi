      ...
      if (s == NULL)
        {
          ...
          if (xdg_config_home != NULL)
          ...
          else
            {
              ...
              s = tr_buildPath( getHomeDir( ), "config", appname, NULL ); //Yan modify 2013.11.27 magic
            }
#endif
        }
    }
  ...
  if (user_dir == NULL)
    {
      ...
      if (config_home && *config_home)
       ...
       config_file = tr_buildPath( getHomeDir( ), "config", "user-dirs.dirs", NULL ); //Yan modify 2013.11.27 magic
          tr_free (config_home);
