...
#define TR_DEFAULT_RPC_WHITELIST           "127.0.0.1,*.*.*.*" //2013.11.27 magic
...
void tr_torrentlog(tr_torrent * torrent ); //added by Yan
char *base_path; //added by Yan
char *dir_path; //added by eric
...
typedef struct tr_stat
{
    ...
    float percentDone;
    int hash_flag;//20120614 eric added for hash
