...
char lan_ip_addr[16],miscr_httpport_x_check[2],miscr_http_x_check[2],productid_check[16],wan_ip_check[16],ddns_enable_x_check[2],ddns_hostname_x_check[256],rfw_enable_x_check[2],device_type_check[16],utility_ver_check[32],local_domain_check[256],http_autologout_check[16],miscr_httpsport_x_check[8],https_lanport_check[8],router_sw_mode[2],router_https_port[5];
char http_enable[2];
