...
function show_footer(){
		...
		( navigator.userAgent.match(/Mobile/i)))
	{
		...
		footer_code +='<span>'+year+multiLanguage_all_array[multi_INT][4]+'</span></div>\n';
		}
	else
	{
		footer_code +='<div align="center" class="copyright">'+year+multiLanguage_all_array[multi_INT][4]+'</div>\n';
		}
