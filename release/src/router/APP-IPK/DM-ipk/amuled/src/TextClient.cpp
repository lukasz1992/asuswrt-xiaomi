...
void CamulecmdApp::OnInitCommandSet()
{
    ...
    tmp = m_commands.AddCommand(wxT("Remove"), CMD_ID_REMOVE, wxTRANSLATE("Remove the server."),
                                wxTRANSLATE("This will remove the severlist for the amule. If the is connected the remove maybe fail"));
