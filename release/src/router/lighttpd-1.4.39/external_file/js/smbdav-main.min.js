...
function doRENAME(a,b,c){var e=0,f=addPathSlash(g_storage.get("openurl")),j=f+b;$(".wcb").each(function(){b==myencodeURI($(this).attr("data-name"))&&(e=1,$(this).attr("isdir")=="1"?alert(m.getString("folder_already_exist_msg")):alert(m.getString("file_already_exist_msg")))});e==1?c&&c():g_webdav_client.LOCK(a,"",function(e,b,h){if(e!="201")alert(m.getString("msg_already_lock")),c&&c();else{var n=getLockToken(h);g_webdav_client.MOVE(a,j,function(e){e[0]==2?(doPROPFIND(f),closeJqmWindow(0)):(alert(m.getString(e)),
...
function doLOGOUT(){doPROPFIND("/",function(){addPathSlash(g_storage.get("openurl"));g_webdav_client.LOGOUT("/",function(a){a[0]==2&&(g_storage.set("openhostuid","0"),g_storage.sett("asus_token",null),window.location.reload())})},0)}function resetTimer(){clearInterval(timer_idle);g_time_count=0;timer_idle=setInterval(function(){g_storage.get("stopLogoutTimer")=="1"||g_show_modal==1?g_time_count=0:(g_time_count++,g_time_count*1E3>g_time_out&&(g_time_count=0,doLOGOUT()))},1E3)}
function doPROPFINDMEDIALIST(a,b,c,e,f,j,d,g,h,n){if(g_webdav_client!=null){showHideLoadStatus(!0);showHideEditUIRegion(!1);try{g_webdav_client.PROPFINDMEDIALIST(a,function(f,j,n){if(f){if(f==207){showHideSelectModeUI(!1);closeUploadPanel();var l=content2XMLDOM(n),n=1,o=f=0,j="Idle";b||(g_folder_array=null,g_folder_array=[],g_file_array=null,g_file_array=[]);l&&(n=1,f=parseInt(l.documentElement.getAttribute("qcount")),parseInt(l.documentElement.getAttribute("qstart")),o=parseInt(l.documentElement.getAttribute("qend")),
...
f==401?setTimeout(function(){openLoginWindow(a)},2E3):alert(m.getString(f));showHideLoadStatus(!1)}},null,e,f,j,d,g,h,n),resetTimer()}catch(l){alert("catch error: "+l)}}}
function parserPropfindXML(a,b,c){if(a){c==!1&&(g_file_array=g_folder_array=null);g_folder_array==null&&(g_folder_array=[]);g_file_array==null&&(g_file_array=[]);for(var e,f,j,d=a.documentElement.childNodes,a=0;a<d.length;a++){var g="",h="",n="",l="",r="",v="",y="",s="",o="",k="",w="",z="",u="",t;j="";for(var x="0",B="",C="0",D=d[a].childNodes,c=0;c<D.length;c++)if(D[c].nodeType==1&&D[c].nodeName=="D:propstat"){var q=D[c].childNodes;for(e=0;e<q.length;e++)if(q[e].nodeName=="D:prop"){var p=q[e].childNodes;
for(f=0;f<p.length;f++)if(!(p[f].childNodes.length<=0))if(p[f].nodeName=="D:getcontenttype")h=String(p[f].childNodes[0].nodeValue);else if(p[f].nodeName=="D:getuniqueid")n=String(p[f].childNodes[0].nodeValue);else if(p[f].nodeName=="D:getonline")v=String(p[f].childNodes[0].nodeValue);else if(p[f].nodeName=="D:getlastmodified")y=String(p[f].childNodes[0].nodeValue);else if(p[f].nodeName=="D:getcontentlength")s=String(size_format(parseInt(p[f].childNodes[0].nodeValue)));else if(p[f].nodeName=="D:getmac")k=
String(p[f].childNodes[0].nodeValue);else if(p[f].nodeName=="D:getip")o=String(p[f].childNodes[0].nodeValue);else if(p[f].nodeName=="D:gettype")w=String(p[f].childNodes[0].nodeValue);else if(p[f].nodeName=="D:getattr"){var E=p[f].childNodes;for(j=0;j<E.length;j++)if(E[j].nodeName=="D:readonly")z=E[j].childNodes[0].nodeValue;else if(E[j].nodeName=="D:hidden")u=E[j].childNodes[0].nodeValue}else if(p[f].nodeName=="D:getuseragent")j=String(p[f].childNodes[0].nodeValue),g_storage.set("user_agent",j);else if(p[f].nodeName==
"D:getroutersync")x=String(p[f].childNodes[0].nodeValue);else if(p[f].nodeName=="D:getmetadata"){E=p[f].childNodes;for(j=0;j<E.length;j++)if(E[j].nodeName=="D:title")B=E[j].childNodes[0].nodeValue;else if(E[j].nodeName=="D:thumb")C=E[j].childNodes[0].nodeValue}}}else D[c].nodeType==1&&D[c].nodeName=="D:href"&&(g=String(D[c].childNodes[0].nodeValue),e="",g.match(/^http/)&&(e=g_storage.get("request_host_url")),f=e+addPathSlash(b),g!=f?(g=g.replace(e,""),l=g.substring(g.lastIndexOf("/")+1,g.length),
l!=""?(t=l,r=l=mydecodeURI(l)):g=""):g="");g!=""&&(h=="httpd/unix-directory"?g_folder_array.push({contenttype:h,furl:g,name:l,uname:t,shortname:r,online:v,time:y,size:s,ip:o,mac:k,uid:n,type:w,freadonly:z,fhidden:u,routersyncfolder:x,matadatatitle:B,thumb:C}):g_file_array.push({contenttype:h,furl:g,name:l,uname:t,shortname:r,online:v,time:y,size:s,ip:o,mac:k,uid:n,type:w,freadonly:z,fhidden:u,routersyncfolder:x,matadatatitle:B,thumb:C}))}}}
...
function doPROPFIND(a,b,c){if(g_webdav_client!=null){showHideLoadStatus(!0);try{g_webdav_client.PROPFIND(a,c,function(e,c,d){if(e){if(e==207){showHideSelectModeUI(!1);closeUploadPanel();var g=content2XMLDOM(d);if(g){e=g.documentElement.getAttribute("qtype");g.documentElement.getAttribute("readonly");c=g.documentElement.getAttribute("ruser");g.documentElement.getAttribute("computername");d=g.documentElement.getAttribute("isusb");g_query_type=e;parserPropfindXML(g,a,!1);g_folder_array.sort(sortByName);
g_file_array.sort(sortByName);for(g=0;g<g_folder_array.length;g++)g_folder_array[g].type=="usbdisk"&&arraymove(g_folder_array,g,0);g=addPathSlash(a);g!="/"&&(g=g.substring(0,g.length-1),g=g.substring(0,g.lastIndexOf("/")),g==""&&(g="/"));a=="/"&&createHostList(e,g_folder_array);var h=g_list_view.get()==1?"listview":"thumbview";create_ui_view(h,$("#main_right_container #fileview"),e,g,g_folder_array,g_file_array,onMouseDownListDIVHandler);g_thumb_loader.init($("#main_right_container #fileview"));g_thumb_loader.start();
showHideAiButton(d=="1"?!0:!1);closeAiMode();a=="/"?($("div#btnThumbView").css("display","none"),$("div#btnListView").css("display","none")):($("div#btnThumbView").css("display",g_list_view.get()==1?"block":"none"),$("div#btnListView").css("display",g_list_view.get()==1?"none":"block"));$("div#btnUpload").css("display",e==0&&g_select_mode==0?"block":"none");$("div#btnNewDir").css("display",e==0&&g_select_mode==0?"block":"none");$("div#btnPlayImage").css("display",e==0&&g_select_mode==0?"block":"none");
$("#btnCancelUpload").css("display",g_upload_mode==1?"block":"none");$("#btnChangeUser").css("display",e==1&&d==0?"block":"none");a=="/"&&($("span#username").text(c),getaccountinfo(c));g_storage.set("isAidisk",d);g_storage.set("openurl",a);$("div#hostview").scrollTop(g_storage.get("hostviewscrollTop"));$("div#fileview").scrollLeft(g_storage.get("contentscrollLeft"));$("div#fileview").scrollTop(g_storage.get("contentscrollTop"));$("#main_right_container #hintbar").hide();adjustLayout();closeJqmWindow(0);
b!=void 0&&b();if(g_storage.get("openhostuid")==void 0||g_storage.get("openhostuid")==0)e="<div id='help_1'>",e+="<div id='help_content'>",e+=m.getString("msg_help"),e+="</div>",e+="<div id='help_image'>",e+="</div>",e+="</div>",$("div#fileview").append(e)}}else e==501?doPROPFIND(a):e==401?setTimeout(function(){openLoginWindow(a)},2E3):alert(m.getString(e));showHideLoadStatus(!1)}},null,1),resetTimer()}catch(e){alert("catch error: "+e)}}}
...
f.documentElement.getAttribute("computername");f.documentElement.getAttribute("isusb");for(f=0;f<c.length;f++){var n="",l="",r="",v="",y="",s="",o="",k="",w="",z="",u="",t="",x="",B,C=c[f].childNodes;for(j=0;j<C.length;j++)if(C[j].nodeType==1&&C[j].nodeName=="D:propstat"){var D=C[j].childNodes;for(d=0;d<D.length;d++)if(D[d].nodeName=="D:prop"){var q=D[d].childNodes;for(g=0;g<q.length;g++)if(!(q[g].childNodes.length<=0))if(q[g].nodeName=="D:getcontenttype")l=String(q[g].childNodes[0].nodeValue);else if(q[g].nodeName==
"D:getuniqueid")r=String(q[g].childNodes[0].nodeValue);else if(q[g].nodeName=="D:getonline")s=String(q[g].childNodes[0].nodeValue);else if(q[g].nodeName=="D:getlastmodified")o=String(q[g].childNodes[0].nodeValue);else if(q[g].nodeName=="D:getcontentlength")k=String(size_format(parseInt(q[g].childNodes[0].nodeValue)));else if(q[g].nodeName=="D:getmac")z=String(q[g].childNodes[0].nodeValue);else if(q[g].nodeName=="D:getip")w=String(q[g].childNodes[0].nodeValue);else if(q[g].nodeName=="D:gettype")u=
String(q[g].childNodes[0].nodeValue);else if(q[g].nodeName=="D:getattr"){var p=q[g].childNodes;for(h=0;h<p.length;h++)if(p[h].nodeName=="D:readonly")t=p[h].childNodes[0].nodeValue;else if(p[h].nodeName=="D:hidden")x=p[h].childNodes[0].nodeValue}}}else C[j].nodeType==1&&C[j].nodeName=="D:href"&&(n=String(C[j].childNodes[0].nodeValue),d="",n.match(/^http/)&&(d=g_storage.get("request_host_url")),g=d+addPathSlash("/"),n!=g?(n=n.replace(d,""),v=n.substring(n.lastIndexOf("/")+1,n.length),v!=""?(B=v,y=v=
mydecodeURI(v),d=g_list_view.get()==0?12:45,y.length>d&&(y=y.substring(0,d)+"...")):n=""):n="");n!=""&&l=="httpd/unix-directory"&&a.push({contenttype:l,href:n,name:v,uname:B,shortname:y,online:s,time:o,size:k,ip:w,mac:z,uid:r,type:u,freadonly:t,fhidden:x})}a.sort(sortByName);for(B=0;B<a.length;B++)a[B].type=="usbdisk"&&arraymove(a,B,0);createHostList(e,a)}},null,1)}catch(a){alert("catch error: "+a)}}function sortByName(a,b){var c=a.name.toLowerCase(),e=b.name.toLowerCase();return c<e?-1:c>e?1:0}
function arraymove(a,b,c){var e=a[b];a.splice(b,1);a.splice(c,0,e)}function onMouseDownThumbDIVHandler(a,b){if(a.button==2)return!1;g_select_mode==1?b.attr("isParent")==1&&(showHideSelectModeUI(!1),openSelItem(b)):openSelItem(b)}function onMouseDownListDIVHandler(a,b){if(a.button==2)return!1;g_select_mode==1?b.attr("isParent")==1&&(showHideSelectModeUI(!1),openSelItem(b)):openSelItem(b)}
...
200?alert(m.getString("wol_ok_msg")):alert(m.getString("wol_fail_msg"))}));else if(e=="1")doPROPFIND(b,null,null);else{c=getFileExt(b);e=g_storage.get("webdav_mode");if(c=="mp4"||c=="m4v"||c=="wmv"||c=="avi"||c=="rmvb"||c=="rm"||c=="mpg"||c=="mpeg"||c=="mkv"||c=="mov"||c=="flv")if(e==0||e==2)if(c=="mp4"||isIE()&&getInternetExplorerVersion()>8){var g=$("div#modalWindow"),d=myencodeURI(d);this_url=j.substring(0,j.lastIndexOf("/"));var h=g_storage.get("request_host_url");h.indexOf("://")!=-1&&(h=h.substr(h.indexOf("://")+
3));h.indexOf(":")!=-1&&(h=h.substring(0,h.indexOf(":")));h="http://"+h+":"+g_storage.get("http_port")+"/";g_webdav_client.OPENSTREAMINGPORT("/",1,function(e){if(e==200){var b=a.attr("matadatatitle");g_webdav_client.GSL(this_url,this_url,d,0,0,function(a,e,c){a==200&&(a=parseXml(c),a=$(a).find("sharelink").text(),e="",e="/smb/css/vlc_video.html?v="+h+a+"&u="+this_url,e+="&t="+b,e+="&showbutton=1",g_modal_url=e,g_modal_window_width=655,g_modal_window_height=580,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(m.getString("title_videoplayer")),
g&&g.jqmShow())})}});return}if(c=="mp3")openAudioPlayer(b);else{if(c=="doc"||c=="docx"||c=="ppt"||c=="pptx"||c=="xls"||c=="xlsx"||c=="pdf")if((isWinOS()||isMacOS())&&!isPrivateIP()){d=myencodeURI(d);this_url=j.substring(0,j.lastIndexOf("/"));g_webdav_client.GSL(this_url,this_url,d,0,0,function(a,e,b){a==200&&(a=parseXml(b),a=decodeURI($(a).find("sharelink").text()),e="",a=g_storage.get("request_host_url")+"/"+a,e="https://docs.google.com/viewer?url="+encodeURI(a),window.open(e))});return}c=="jpg"||
c=="jpeg"||c=="png"||c=="gif"?(j=getPageSize(),g_image_player.show(b,j[0],j[1],g_file_array)):window.open(b)}}}
function addtoFavorite(){var a=g_storage.get("ddns_host_name"),b="https://"+a,c=isIE();a==""&&(b=g_storage.get("request_host_url"));if(typeof window.sidebar=="object"&&typeof window.sidebar.addPanel=="function")return window.sidebar.addPanel("AiCloud",b,""),!1;else if(c&&typeof window.external=="object")return window.external.AddFavorite(b,"AiCloud"),!1;else{window.location=b;var a=navigator.userAgent.toLowerCase(),b="",c=a.indexOf("webkit")!=-1,e=a.indexOf("mac")!=-1;if(a.indexOf("konqueror")!=-1)b=
"CTRL + B";else if(window.home||c||e)b=(e?"Command/Cmd":"CTRL")+" + D";b=b?m.getString("msg_add_favorite1")+b+m.getString("msg_add_favorite2"):b;alert(b)}}
function getaccountinfo(a){var b=new davlib.DavClient;b.initialize();b.GETACCOUNTINFO("/",a,function(a,e,b){a==200?(a=parseXml(b),e=$(a),e.find("username").text(),e.find("type").text(),a=e.find("permission").text(),e=e.find("name").text(),$("span#username").text(e),g_storage.set("userpermission",a)):g_storage.set("userpermission","user");refreshAdminUI()},null)}
function getMouseXY(a){document.all?(g_mouse_x=event.clientX+document.body.scrollLeft+document.documentElement.scrollLeft,g_mouse_y=event.clientY+document.body.scrollTop+document.documentElement.scrollTop):(g_mouse_x=a.pageX,g_mouse_y=a.pageY);g_mouse_x<0&&(g_mouse_x=0);g_mouse_y<0&&(g_mouse_y=0);return!0}
...
g_storage.set("isOpenModalWindow","0");g_storage.set("isOnUploadFile","0");createLayout();showHideLoadStatus(!1);adjustLayout();(function(){g_storage.get("openurl");g_webdav_client.GETROUTERINFO("/",function(a,b,c){a==200&&(a=parseXml(c),a=$(a),g_storage.set("request_host_url",a.find("request_host_url").text()),g_storage.set("webdav_mode",a.find("webdav_mode").text()),g_storage.set("http_port",a.find("http_port").text()),g_storage.set("https_port",a.find("https_port").text()),g_storage.set("http_enable",
a.find("http_enable").text()),g_storage.set("misc_http_enable",a.find("misc_http_enable").text()),g_storage.set("misc_http_port",String(a.find("misc_http_port").text()).replace("\n","")),g_storage.set("misc_https_port",String(a.find("misc_https_port").text()).replace("\n","")),g_storage.set("lan_https_port",String(a.find("lan_https_port").text()).replace("\n","")),g_storage.set("last_login_info",a.find("last_login_info").text()),g_storage.set("ddns_host_name",a.find("ddns_host_name").text()),g_storage.set("router_version",
a.find("version").text()),g_storage.set("aicloud_version",a.find("aicloud_version").text()),g_storage.set("smartsync_version",a.find("smartsync_version").text()),g_storage.set("wan_ip",a.find("wan_ip").text()),g_storage.set("modalname",a.find("modalname").text()),g_storage.set("usbdiskname",a.find("usbdiskname").text()),g_storage.set("dms_enable",a.find("dms_enable").text()),g_storage.set("account_manager_enable",a.find("account_manager_enable").text()),g_storage.set("app_installation_url",a.find("app_installation_url").text()),
g_storage.set("https_crt_cn",a.find("https_crt_cn").text()),g_storage.set("max_sharelink",a.find("max_sharelink").text()),a=g_storage.get("last_login_info"),a!=""&&a!=void 0&&a!=null&&(a=String(a).split(">"),a=m.getString("title_logininfo")+a[1]+", "+m.getString("title_ip")+a[2],$("#login_info").text(a)),refreshAdminUI())})})();if(g_fileview_only==0){var c=g_storage.get("openurl");g_storage.set("HostList","");doPROPFIND("/",function(){c!=void 0&&c!="/"&&doPROPFIND(c)},0)}else c=g_storage.get("openurl"),
doPROPFIND(c);initAudioPlayer();g_window_height=$(window).height();$("#modalWindow").jqm({overlay:70,modal:!0,target:"#jqmContent",onHide:function(a){var b=$(a.w);a.o.remove();b.fadeOut("200",function(){g_show_modal=0;if(g_reload_page==1){var a=addPathSlash(g_storage.get("openurl"));doPROPFIND(a)}})},onShow:function(a){var a=$(a.w),b=$("#jqmContent",a);$("#jqmTitle",a);var c=(getPageSize()[0]-g_modal_window_width)/2;g_show_modal=1;navigator.userAgent.toLowerCase();var d=function(){var a=-1;navigator.appName==
...
doPROPFIND(a)})}});$("#btnThumbView").click(function(){g_list_view.set(0);$("#btnThumbView").css("display","none");$("#btnListView").css("display","block");var a=g_storage.get("openurl"),a=a==void 0?"/":a,b=isAiModeView();if(b<0)doPROPFIND(a);else{var c=g_storage.get("data-id")==void 0?"":g_storage.get("data-id"),d=myencodeURI($("div#boxSearch input").val());doPROPFINDMEDIALIST(a,!1,null,b,"0","50",d,"TIMESTAMP","DESC",c)}});$("#btnListView").click(function(){g_list_view.set(1);$("#btnThumbView").css("display",
"block");$("#btnListView").css("display","none");var a=g_storage.get("openurl"),a=a==void 0?"/":a,b=isAiModeView();if(b<0)doPROPFIND(a);else{var c=g_storage.get("data-id")==void 0?"":g_storage.get("data-id"),d=myencodeURI($("div#boxSearch input").val());doPROPFINDMEDIALIST(a,!1,null,b,"0","50",d,"TIMESTAMP","DESC",c)}});$("#btnUpload2").click(function(){g_upload_mode=1;$("div#btnNewDir").css("display","none");$("div#btnUpload").css("display","none");$("div#btnPlayImage").css("display","none");$("div#boxSearch").css("display",
"none");$("#upload_panel").css("display","block");$("#upload_panel").css("left","1999px");$("#upload_panel").animate({left:"0px"},"slow");var a=addPathSlash(g_storage.get("openurl"));$("#upload_panel iframe").attr("src","/smb/css/upload.html?u="+a);$("#function_help").text(m.getString("msg_uploadmode_help"));adjustLayout()});$("#btnCancelUpload").click(closeUploadPanel);$(".mediaListDiv").mousedown(function(){var a=$(this).attr("qtype"),b=g_storage.get("openurl");g_storage.set("data-id","");$(".mediaListDiv").removeClass("down");
$(this).addClass("down");g_ui_mode.set(a);doPROPFINDMEDIALIST(b,!1,function(){},a,"0","50",null,"TIMESTAMP","DESC")});$("div#btnAiMusicPopupMenux").click(function(){var a="<div class='popupmenu' id='popupmenu'>";a+="<div class='menuitem' id='classifyByAlbum'>";a+="<div class='menuitem-content' style='-webkit-user-select: none;'>";a+="<span class='menuitem-icon a-inline-block' style='-webkit-user-select: none;'>&nbsp;</span>";a+="<span class='menuitem-container a-inline-block' style='-webkit-user-select: none;'>";
a+="<span class='menuitem-caption a-inline-block' style='-webkit-user-select: none;'>";a+="<div style='-webkit-user-select: none;'>"+m.getString("title_sort_by_album")+"</div>";a+="</span>";a+="</span>";a+="</div>";a+="</div>";a+="<div class='menuitem' id='classifyByArtist'>";a+="<div class='menuitem-content' style='-webkit-user-select: none;'>";a+="<span class='menuitem-icon a-inline-block' style='-webkit-user-select: none;'>&nbsp;</span>";a+="<span class='menuitem-container a-inline-block' style='-webkit-user-select: none;'>";
a+="<span class='menuitem-caption a-inline-block' style='-webkit-user-select: none;'>";a+="<div style='-webkit-user-select: none;'>"+m.getString("title_sort_by_artist")+"</div>";a+="</span>";a+="</span>";a+="</div>";a+="</div>";a+="</div>";$(a).appendTo("body");$(".popupmenu").css("left",g_mouse_x-$(".popupmenu").width()+"px");$(".popupmenu").css("top",g_mouse_y-$(".popupmenu").height()+"px");$("#classifyByAlbum").click(function(a){if(g_webdav_client!=null){showHideLoadStatus(!0);var b=g_storage.get("openurl");
g_webdav_client.GETMUSICCLASSIFICATION(b==void 0?"/":b,"album",function(a,b,e){a==200?createClassificationView(e,"album"):a==503&&show_hint_no_mediaserver();showHideLoadStatus(!1)});a.preventDefault();return!1}});$("#classifyByArtist").click(function(){if(g_webdav_client!=null){showHideLoadStatus(!0);var a=g_storage.get("openurl");g_webdav_client.GETMUSICCLASSIFICATION(a==void 0?"/":a,"artist",function(a,b,e){a==200?createClassificationView(e,"artist"):a==503&&show_hint_no_mediaserver();showHideLoadStatus(!1)})}})});
$("div#hostview").scroll(function(){g_storage.set("hostviewscrollTop",$(this).scrollTop())});$("div#fileview").scroll(function(){g_storage.set("contentscrollLeft",$(this).scrollLeft());g_storage.set("contentscrollTop",$(this).scrollTop())});$(".navigation#lan dd a").click(function(){if(confirmCancelUploadFile()!=0){var a=$(this).attr("id");g_storage.set("lan",a);window.location.reload()}});$(".navigation#setting dd a").click(function(){var a=$(this).attr("id");if(a=="logout")confirmCancelUploadFile()!=
0&&(a=confirm(m.getString("msg_logout_confirm")),a==!0&&doLOGOUT());else if(a=="mobile"){var b=g_storage.get("request_host_url"),b=b.substr(0,b.lastIndexOf("?"));window.location=b+"?mobile=1"}else if(a=="favorite")addtoFavorite();else if(a=="config"){var a=parseInt(g_storage.get("http_enable")),b=parseInt(g_storage.get("misc_http_enable")),c=g_storage.get("misc_http_port"),d=g_storage.get("misc_https_port"),g=g_storage.get("lan_https_port"),h=g_storage.get("request_host_url"),n="http",l=c;h.indexOf("://")!=
-1&&(h=h.substr(h.indexOf("://")+3));b==0&&!isPrivateIP()?alert(m.getString("msg_no_config")):(a==1?(n="https",l=d):(n="http",l=c),isPrivateIP()?(b=n+"://"+h.split(":")[0],a==1&&(b+=":"+g)):(b=n+"://"+h.split(":")[0],l!=""&&(b+=":"+l)),window.location=b)}else a=="rescan_samba"?confirmCancelUploadFile()!=0&&(a=confirm(m.getString("title_desc_rescan")),a==!0&&doRescanSamba()):a=="sharelink"?(a=$("div#modalWindow"),g=getPageSize(),g_modal_url="/smb/css/setting.html?p=1&s=1",g_modal_window_width=800,
g_modal_window_height=g[1]-30,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(m.getString("title_setting")),a&&a.jqmShow()):a=="account"?(a=$("div#modalWindow"),g=getPageSize(),g_modal_url="/smb/css/setting.html?p=5&s=1",g_modal_window_width=800,g_modal_window_height=g[1]-30,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(m.getString("title_setting")),a&&a.jqmShow()):a=="version"?(a=$("div#modalWindow"),g=getPageSize(),g_modal_url="/smb/css/setting.html?p=2&s=1",g_modal_window_width=
...
800,g_modal_window_height=g[1]-30,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(m.getString("title_community")),a&&a.jqmShow()):a!="test_func"&&a=="test_func2"&&g_webdav_client.NVRAMGET("/","rc_support;webdav_last_login_info",function(a,b,c){a==200?(a=parseXml(c),$(a).find("nvram").each(function(){var a=$(this).attr("key"),b=$(this).attr("value");alert("key="+a+", value="+b)})):alert(a)})});$(".navigation#refresh dt a").click(function(){var a=g_storage.get("openurl");g_storage.set("HostList",
...
[];for(a=0;a<g_select_array.length;a++)c=g_select_array[a].uhref,b.push(c);open_sharelink_window("other",b)}},items:{submenu_upload:{name:m.getString("title_upload2"),disabled:function(){if(g_select_array.length<=0)return!0;for(var a=0;a<g_select_array.length;a++){var b=getFileExt(g_select_array[a].uhref);if(b=="jpg"||b=="jpeg"||b=="png"||b=="gif")return!1}return!0},items:{upload2facebook:{name:m.getString("title_facebook")},upload2picasa:{name:m.getString("title_picasa")},upload2twitter:{name:m.getString("title_twitter")}}},
submenu_share:{name:m.getString("title_share2"),items:{share2facebook:{name:m.getString("title_facebook")},share2googleplus:{name:m.getString("title_googleplus")},share2twitter:{name:m.getString("title_twitter")},share2plurk:{name:m.getString("title_plurk")},share2weibo:{name:m.getString("title_weibo")},share2qq:{name:m.getString("title_qq")}}},sharelink:{name:m.getString("title_gen_sharelink")}}});$.contextMenu({selector:"div#btnCopyMove",trigger:"left",callback:function(a){if((a=="copy"||a=="move")&&
!(g_select_array.length<=0)){for(var b=g_storage.get("openurl"),c=[],d=0;d<g_select_array.length;d++)c.push(g_select_array[d].title);open_copymove_window(a,b,c)}},items:{copy:{name:m.getString("func_copy")},move:{name:m.getString("func_move")}}});isBrowser("chrome")?$.contextMenu({selector:"div#btnUpload",trigger:"left",callback:function(a){a=="uploadfile"?open_uploadfile_window():a=="uploadfolder"&&open_uploadfolder_window()},items:{uploadfile:{name:m.getString("title_upload_file")},uploadfolder:{name:m.getString("title_upload_folder"),
disabled:!isBrowser("chrome")}}}):$("div#btnUpload").click(function(){open_uploadfile_window()});$.contextMenu({selector:"div#btnAiMusicPopupMenu",trigger:"left",callback:function(a){a=="sort_by_album"?g_webdav_client!=null&&(showHideLoadStatus(!0),a=g_storage.get("openurl"),g_webdav_client.GETMUSICCLASSIFICATION(a==void 0?"/":a,"album",function(a,b,c){a==200?createClassificationView(c,"album"):a==503&&show_hint_no_mediaserver();showHideLoadStatus(!1)})):a=="sort_by_artist"&&g_webdav_client!=null&&
(showHideLoadStatus(!0),a=g_storage.get("openurl"),g_webdav_client.GETMUSICCLASSIFICATION(a==void 0?"/":a,"artist",function(a,b,c){a==200?createClassificationView(c,"artist"):a==503&&show_hint_no_mediaserver();showHideLoadStatus(!1)}))},items:{sort_by_album:{name:m.getString("title_sort_by_album")},sort_by_artist:{name:m.getString("title_sort_by_artist")}}});$.contextMenu({selector:".item-menu",trigger:"left",events:{show:function(){},hide:function(){$(this).removeClass("x-view-menu-popup")}},callback:function(a){var b=
$(this).parents(".wcb"),c=b.attr("uhref"),d=encodeURIComponent(b.attr("data-name")),b=b.attr("isdir");if(a=="delete")c!=""&&confirm(m.getString("del_files_msg")+" - "+decodeURIComponent(d))==!0&&g_webdav_client.DELETE(c,function(){var a=addPathSlash(g_storage.get("openurl"));doPROPFIND(a)});else if(a=="copy")open_copymove_window(a,g_storage.get("openurl"),d);else if(a=="move")open_copymove_window(a,g_storage.get("openurl"),d);else if(a=="rename")open_rename_window(d,c,b);else if(a=="download")b==
"1"?download_folder(c):download_file(c);else if(a=="upload2facebook")open_upload2service_window("facebook",c);else if(a=="upload2flickr")open_upload2service_window("flickr",c);else if(a=="upload2picasa")open_upload2service_window("picasa",c);else if(a=="upload2twitter")open_upload2service_window("twitter",c);else if(a=="share2facebook")open_sharelink_window("facebook",c);else if(a=="share2googleplus")open_sharelink_window("googleplus",c);else if(a=="share2twitter")open_sharelink_window("twitter",
c);else if(a=="share2plurk")open_sharelink_window("plurk",c);else if(a=="share2weibo")open_sharelink_window("weibo",c);else if(a=="share2qq")open_sharelink_window("qq",c);else if(a=="sharelink"){a=[];for(c=0;c<g_select_array.length;c++)a.push(g_select_array[c].uhref);open_sharelink_window("other",a);a=null}},items:{"delete":{name:m.getString("func_delete"),disabled:function(){if(g_storage.get("aimode")==1||g_storage.get("aimode")==2||g_storage.get("aimode")==3||g_query_type!=0)return!0}},submenu_copymove:{name:m.getString("title_copymove"),
items:{copy:{name:m.getString("func_copy")},move:{name:m.getString("func_move")}}},rename:{name:m.getString("func_rename"),disabled:function(){if(g_storage.get("aimode")==1||g_storage.get("aimode")==2||g_storage.get("aimode")==3||g_query_type!=0)return!0}},sep1:"---------",download:{name:m.getString("func_download"),disabled:function(){if(g_select_array.length<=0)return!0;for(var a=0;a<g_select_array.length;a++)if(g_select_array[a].isdir=="1")return!0;return!1}},sep2:"---------",submenu_upload:{name:m.getString("title_upload2"),
disabled:function(){if(g_select_array.length<=0)return!0;for(var a=0;a<g_select_array.length;a++){var b=getFileExt(g_select_array[a].uhref);if(b=="jpg"||b=="jpeg"||b=="png"||b=="gif")return!1}return!0},items:{upload2facebook:{name:m.getString("title_facebook")},upload2picasa:{name:m.getString("title_picasa")},upload2twitter:{name:m.getString("title_twitter")}}},submenu_share:{name:m.getString("title_share2"),items:{share2facebook:{name:m.getString("title_facebook")},share2googleplus:{name:m.getString("title_googleplus")},
...
!0&&doLOGOUT()});var e;$(".navigation li").click(function(){clearInterval(e);$(this).find(".nav_option").fadeIn("fast",function(){$(this).css("display","block")})});$(".navigation li").mouseenter(function(){var a=$(this);clearInterval(e);e=setTimeout(function(){a.find(".nav_option").fadeIn("fast",function(){$(this).css("display","block")})},500)});$(".navigation li, .navigation li a").mouseleave(function(){clearInterval(e);$(this).find(".nav_option").fadeOut("fast")});$("#mainCss").attr("href","/smb/css/style-theme.css");
$("#btnHelp").attr("title",m.getString("title_help"));$("#btnLogout").attr("title",m.getString("title_logout"));$("#btnConfig").attr("title",m.getString("btn_config"));$("#btnUpload").attr("title",m.getString("btn_upload"));$("#btnCancelUpload").attr("title",m.getString("btn_cancelupload"));$("#btnNewDir").attr("title",m.getString("btn_newdir"));$("#btnShareLink").attr("title",m.getString("btn_sharelink"));$("#btnDeleteSel").attr("title",m.getString("btn_delselect"));$("#btnDownload").attr("title",
m.getString("func_download"));$("#btnRename").attr("title",m.getString("btn_rename"));$("#btnCopyMove").attr("title",m.getString("title_copymove"));$("#btnSetting").attr("title",m.getString("title_setting"));$("#btnRefresh").attr("title",m.getString("btn_refresh"))}
...
g_storage.get("openurl");g_webdav_client.GETMUSICPLAYLIST(b==void 0?"/":b,$(this).attr("data-id"),function(a,b,c){if(a==200){a=parseXml(c);$(a);var e=[];$(a).find("item").each(function(){var a=g_storage.get("request_host_url"),b=$(this).find("title").text(),a=a+"/"+$(this).find("sharelink").text(),c=[];c.name=mydecodeURI(b);c.mp3=a;e.push(c)});openAudioPlayerByPlayList(e)}});a.preventDefault();return!1})}
...
function adjustLayout(){var a=getPageSize(),b=a[0],c=a[0],a=a[1]-$("#header_region").height()-$("#bottom_region").height();$("#main_region #main_right_region").css("width",c-parseInt($("#main_region #main_right_region").css("left")));$("#main_region #button_panel").css("left",$("#main_region #main_right_region").css("left"));$("#main_region #button_panel").css("width",$("#main_region #main_right_region").width());$("#main_region #button_panel").css("bottom",$("#bottom_region").height());c=a-$("#main_left_region #infobar").height();
$("#hostview").css("height",c);var e=0;$("#toolbar .albutton").each(function(){$(this).css("display")=="block"&&(e+=$(this).width())});$("#toolbar .alsearch").css("display")=="block"&&(e+=$("#toolbar .alsearch").width());$("#urlregion-url").css("width",$("#toolbar").width()-e-20);createOpenUrlUI(g_storage.get("openurl"));c=a-$("#main_right_region #infobar").height()-$("#main_region #button_panel").height();$("#main_right_container #hintbar").css("display")=="block"&&(c-=$("#main_right_container #hintbar").height());
$("#fileview").css("height",c);$("#upload_panel").css("height",c);$("#function_help").css("left",$("#main_left_region").width());if(c=$("div#modalWindow"))a=(b-g_modal_window_width)/2,c.css("left",a);a=(b-$(".select-window").width())/2;$(".select-window").css("left",a);$("#header-fixed").css("width",$("#ntl").width());b=$("#header_region").height()+$("#main_right_region #infobar").height()+2;$("#main_right_container #hintbar").css("display")=="block"&&(b+=$("#main_right_container #hintbar").height());
...
$("#btnDownload").addClass("disable"),$("#btnShareLink").addClass("disable"),$("#btnCopyMove").addClass("disable"));g_select_file_count+g_select_folder_count==1&&isAiModeView()<0?$("#btnRename").removeClass("disable"):$("#btnRename").addClass("disable");g_query_type!=0&&($("#btnRename").addClass("disable"),$("#btnDeleteSel").addClass("disable"));g_bshowHideEditUIRegion=a}
...
function show_hint_no_mediaserver(){$("#main_right_container #fileview").empty();var a=g_storage.get("http_enable"),b=g_storage.get("misc_http_enable"),c=g_storage.get("misc_http_port"),e=g_storage.get("misc_https_port"),f="http",j=c,d=g_storage.get("request_host_url");d.indexOf("://")!=-1&&(d=d.substr(d.indexOf("://")+3));b==0&&!isPrivateIP()?$("#main_right_container #hintbar").html(m.getString("msg_no_mediaserver")):(a=="0"?(f="http",j=c):a=="1"&&(f="https",j=e),isPrivateIP()?a=f+"://"+d.split(":")[0]:
(a=f+"://"+d.split(":")[0],j!=""&&(a+=":"+j)),j=g_storage.get("app_installation_url"),j==""?a+="/APP_Installation.asp":(j.indexOf("/")!=0&&(j="/"+j),a+=j),j="<a href='"+a+"' target='_blank'>"+m.getString("msg_no_mediaserver")+"</a>",$("#main_right_container #hintbar").html(j));$("#main_right_container #hintbar").show()}
...
for(c=0;c<e.length;c++){var g=m.getString("table_filename")+": "+e[c].name;e[c].time!=""&&(g+="\n"+m.getString("table_time")+": "+e[c].time);d+='<div class="albumDiv fcb wcb" ';d+=' title="';d+=g;d+='" qtype="';d+=b;d+='" isParent="0" isdir="1" uhref="';d+=e[c].furl;d+='" data-name="';d+=e[c].name;d+='" data-thumb="';d+=e[c].thumb;d+='" online="';d+=e[c].online;d+='" ip="" mac="';d+=e[c].mac;d+='" uid="';d+=e[c].uid;d+='" freadonly="';d+=e[c].freadonly;d+='" fhidden="';d+=e[c].fhidden;d+=e[c].type==
"usbdisk"?'" isusb="1"':'" isusb="0"';d+='">';d+='<table class="thumb-table-parent">';d+="<tbody>";d+="<tr><td>";d+='<div class="picDiv cb" popupmenu="';d+=b=="0"?"1":"0";d+='" uhref="';d+=e[c].furl;d+='">';d+=b=="2"?e[c].type=="usbdisk"?'<div id="fileviewicon" class="usbDiv bicon">':e[c].online=="1"?'<div id="fileviewicon" class="computerDiv bicon">':'<div id="fileviewicon" class="computerOffDiv bicon">':'<div id="fileviewicon" class="folderDiv bicon">';e[c].routersyncfolder=="1"&&(d+='<div id="routersyncicon" class="routersyncDiv sicon"></div>');
...
"</tbody>";d+="</table>";d+='<div class="item-check ui-icon"></div>';d+='<div class="item-menu ui-icon"></div>';d+="</div>"}a.append(d);$(".thumb-table-parent").mousedown(function(a){var b=$(this).parents(".fcb");j(a,b)})}
...
f.length;c++)b=getFileExt(String(f[c].furl)),b.length>5&&(b=""),d+='<tr class="listDiv fcb wcb"',d+=' id="list_item" qtype="1" isdir="0" uhref="',d+=f[c].furl,d+='" title="',d+=f[c].name,d+='" matadatatitle="',d+=f[c].matadatatitle,d+='" uid="',d+=f[c].uid,d+='" ext="',d+=b,d+='" freadonly="',d+=f[c].freadonly,d+='" fhidden="',d+=f[c].fhidden,d+='" data-thumb="',d+=f[c].thumb,d+='" data-name="',d+=f[c].name,d+=f[c].type=="usbdisk"?'" isusb="1"':'" isusb="0"',d+='">',d+='<td field="check">',d+='<div class="checklist">',
d+='<div class="item-check ui-icon"></div>',d+="</div>",d+="</td>",d+='<td field="icon">',d+=b=="jpg"||b=="jpeg"||b=="png"||b=="gif"||b=="bmp"?'<div id="fileviewicon" class="imgfileDiv sicon">':b=="mp3"||b=="m4a"||b=="m4r"||b=="wav"?'<div id="fileviewicon" class="audiofileDiv sicon">':b=="mp4"||b=="rmvb"||b=="m4v"||b=="wmv"||b=="avi"||b=="mpg"||b=="mpeg"||b=="mkv"||b=="mov"||b=="flv"||b=="3gp"||b=="m2v"||b=="rm"?'<div id="fileviewicon" class="videofileDiv sicon">':b=="doc"||b=="docx"?'<div id="fileviewicon" class="docfileDiv sicon">':
b=="ppt"||b=="pptx"?'<div id="fileviewicon" class="pptfileDiv sicon">':b=="xls"||b=="xlsx"?'<div id="fileviewicon" class="xlsfileDiv sicon">':b=="pdf"?'<div id="fileviewicon" class="pdffileDiv sicon">':'<div id="fileviewicon" class="fileDiv sicon">',d+="</td>",d+='<td field="filename" align="left">'+f[c].name+"</td>",d+='<td field="time" align="left">'+f[c].time+"</td>",d+='<td field="size" align="left">'+f[c].size+"</td>",d+='<td field="option" align="left">',d+='<div class="checklist">',d+='<div class="item-menu ui-icon"></div>',
d+="</div>",d+="</td>",d+="</tr>";d+="</tbody>";d+="</table>";d+='<table id="header-fixed" class="table-file-list"></table>';a.append(d);$("td[field=icon], td[field=filename], td[field=time], td[field=size]").mousedown(function(a){j(a,$(this).parent(".listDiv"))});var g=$("#ntl").offset().top,a=$("#ntl > thead").clone(),h=$("#header-fixed").append(a);$("#header-fixed").css("width",$("#ntl").width());$("#fileview").bind("scroll",function(){var a=$(this).scrollTop();a>=g&&h.is(":hidden")?h.show():a<
g&&h.hide()})};var g_image_player={loc:"",page_width:0,page_height:0,file_array:null,show_exif_mode:0,settings:null,keydown:function(a){this.settings&&(a.keyCode==27?this.close():a.keyCode==37?$("#"+this.settings.name).prev(this.settings):a.keyCode==39&&$("#"+this.settings.name).next(this.settings))},adjustLayout:function(){this.settings&&$("#"+this.settings.name).adjustLayout(this.settings)},close:function(){this.settings&&$("#"+this.settings.name).close(this.settings)},show:function(a,b,c,e){var f=this;this.loc=
a;this.page_width=b;this.page_height=c;this.file_array=e;a=[];for(b=0;b<this.file_array.length;b++)c=getFileExt(this.file_array[b].furl),(c=="jpg"||c=="jpeg"||c=="png"||c=="gif")&&a.push(this.file_array[b]);if(a.length==0)alert(m.getString("msg_no_image_list"));else{for(b=c=0;b<a.length;b++)this.loc==a[b].furl&&(c=b);e="";e+='<div id="image_slide_show" class="barousel unselectable" style="height: 0; width: 0; position: fixed; background-color: rgb(0, 0, 0); left: ';e+=this.page_width/2;e+="px; top: ";
e+=this.page_height/2;e+='px; z-index: 2999;">';e+='<div class="barousel_image">';for(var j=window.location.protocol+"//"+window.location.host,b=0;b<a.length;b++){var d=j+a[b].furl;e+=b==c?'<img src="" path="'+d+'" uhref="'+a[b].furl+'" file="'+a[b].name+'" alt="" class="default"/>':'<img src="" path="'+d+'" uhref="'+a[b].furl+'" file="'+a[b].name+'" alt="" class=""/>'}e+="</div>";e+='<div class="barousel_nav">';e+='<div class="barousel_content transparent" style="display: block; ">';for(b=0;b<a.length;b++)e+=
...
manualCarousel:1,contentResize:0,startIndex:c,storage:g_storage,stringTable:m,enableExifFunc:1,enableShareFunc:1,closeHandler:function(){f.file_array=null;f.settings=null},initCompleteHandler:function(a){f.settings=a}});a=null}}};var g_audioPlayer=null,g_audio_playlist=[],g_onPlaying=!1;function openAudioPlayer(a){for(var b=[],c=0;c<g_file_array.length;c++)getFileExt(g_file_array[c].furl)=="mp3"&&b.push(g_file_array[c]);if(b.length==0)alert(m.getString("msg_no_image_list"));else{for(var e="",f=0,c=0;c<b.length;c++){var j=b[c].furl;a==j&&(f=c);e+=j;c!=b.length-1&&(e+=",")}get_mp3_url(e,!0,function(a){g_audioPlayer.showHideAudioPlayerWindow(!0,function(){g_audioPlayer.addPlaylist(a,f)})})}}
...
function get_mp3_url(a,b,c){if(a!=""){var e=g_audio_playlist,f=a.split(","),j=0,d=!1;g_audio_playlist=[];for(a=0;a<e.length;a++)for(var g=0;g<f.length;g++)e[a].source==f[g]&&(g_audio_playlist.push(e[a]),f.splice(g,1),g=-1);if(b)var h=g_storage.get("request_host_url")+"/",n=setInterval(function(){if(d==!1)if(j<0||j>f.length-1)clearInterval(n),c(g_audio_playlist);else{var a=f[j],b=a.substring(a.lastIndexOf("/")+1,a.length),e=a.substring(0,a.lastIndexOf("/"));d=!0;g_webdav_client.GSL(e,e,b,0,0,function(c,
e,f){if(c==200)c=parseXml(f),c=$(c).find("sharelink").text(),c=h+c,d=!1,e=[],e.source=a,e.name=mydecodeURI(b),e.mp3=c,g_audio_playlist.push(e),j++})}},100);else{for(a=0;a<f.length;a++)b=f[a],e=b.substring(b.lastIndexOf("/")+1,b.length),b.substring(0,b.lastIndexOf("/")),g=[],g.source=b,g.name=mydecodeURI(e),g.mp3=b,g_audio_playlist.push(g);c(g_audio_playlist)}}}
...
adjustUploadLayout()}function adjustUploadLayout(){var a=$("#upload_panel").height()-20;$("#main_table").css("height",a);$("#uploadRegion").css("height",a-120);$("#upload-file-list-container").css("height",a-144)}function traverseFileTree(a,b){b=b||"";a.isFile?a.file(function(a){add_to_upload_files(b,a);outputUploadResult()}):a.isDirectory&&a.createReader().readEntries(function(c){for(var e=0;e<c.length;e++)traverseFileTree(c[e],b+a.name+"/")})}
...
""));add_to_upload_files(e,c)}$("#upload-container").hide();outputUploadResult()}function handleDragOver(a){a.stopPropagation();a.preventDefault()}
function outputUploadResult(){for(var a=[],b=0,c;c=this_upload_files[b];b++){var e=size_format(c.thefile.size),f=String(c.id),j=c.thepath,d=c.thefile.name;g_storage.get("isOnUploadFile")==1?a.push("<li><strong>",j+d,"</strong> "," - ",e,m.getString("upload_item"),' [ <span id="status">',m.getString(c.status),"</span> ] ","</li>"):a.push('<li id="',f,'"><strong>',j+d,"</strong> "," - ",e,m.getString("upload_item"),' [ <span id="status">',m.getString(c.status),"</span> ]",'<span class="ui-icon" id="delete_item" item="',
...
b!=""&&a.setImage(c,b));a._array.shift();a._onLoading=!1})}},100)},stop:function(){this._array=null;clearInterval(this._timer)}};(function(a,b){function c(a){for(var a=a.split(/\s+/),b=[],c=0,d;d=a[c];c++)d=d[0].toUpperCase(),b.push(d);return b}function e(b){return b.id&&a('label[for="'+b.id+'"]').val()||b.name}function f(c,d,t){t||(t=0);d.each(function(){var d=a(this),u=this,g=this.nodeName.toLowerCase(),k,o;g=="label"&&d.find("input, textarea, select").length&&(k=d.text(),d=d.children().first(),u=d.get(0),g=u.nodeName.toLowerCase());switch(g){case "menu":o={name:d.attr("label"),items:{}};t=f(o.items,d.children(),t);break;
...
name:d.attr("label"),radio:d.attr("radiogroup"),value:d.attr("id"),selected:!!d.attr("checked")};break;default:o=b}break;case "hr":o="-------";break;case "input":switch(d.attr("type")){case "text":o={type:"text",name:k||e(u),disabled:!!d.attr("disabled"),value:d.val()};break;case "checkbox":o={type:"checkbox",name:k||e(u),disabled:!!d.attr("disabled"),selected:!!d.attr("checked")};break;case "radio":o={type:"radio",name:k||e(u),disabled:!!d.attr("disabled"),radio:!!d.attr("name"),value:d.val(),selected:!!d.attr("checked")};
break;default:o=b}break;case "select":o={type:"select",name:k||e(u),disabled:!!d.attr("disabled"),selected:d.val(),options:{}};d.children().each(function(){o.options[this.value]=a(this).text()});break;case "textarea":o={type:"textarea",name:k||e(u),disabled:!!d.attr("disabled"),value:d.val()};break;case "label":break;default:o={type:"html",html:d.clone(!0)}}o&&(t++,c["key"+t]=o)});return t}a.support.htmlMenuitem="HTMLMenuItemElement"in window;a.support.htmlCommand="HTMLCommandElement"in window;a.support.eventSelectstart=
"onselectstart"in document.documentElement;if(!a.ui||!a.ui.widget){var j=a.cleanData;a.cleanData=function(b){for(var c=0,d;(d=b[c])!=null;c++)try{a(d).triggerHandler("remove")}catch(e){}j(b)}}var d=null,g=!1,h=a(window),n=0,l={},r={},v={},y={selector:null,appendTo:null,trigger:"right",autoHide:!1,delay:200,reposition:!0,determinePosition:function(b){if(a.ui&&a.ui.position)b.css("display","block").position({my:"center top",at:"center bottom",of:this,offset:"0 5",collision:"fit"}).css("display","none");
...
b.data.$trigger=d;w.create(b.data)}w.show.call(c,b.data,b.pageX,b.pageY)}},click:function(b){b.preventDefault();b.stopImmediatePropagation();a(this).trigger(a.Event("contextmenu",{data:b.data,pageX:b.pageX,pageY:b.pageY}))},mousedown:function(b){var c=a(this);d&&d.length&&!d.is(c)&&d.data("contextMenu").$menu.trigger("contextmenu:hide");b.button==2&&(d=c.data("contextMenuActive",!0))},mouseup:function(b){var c=a(this);c.data("contextMenuActive")&&d&&d.length&&d.is(c)&&!c.hasClass("context-menu-disabled")&&
...
if(a.isFunction(e.callbacks[f])&&Object.prototype.hasOwnProperty.call(e.callbacks,f))b=e.callbacks[f];else if(a.isFunction(e.callback))b=e.callback;else return;b.call(e.$trigger,f,e)!==!1?e.$menu.trigger("contextmenu:hide"):e.$menu.parent().length&&w.update.call(e.$trigger,e)}},inputClick:function(a){a.stopImmediatePropagation()},hideMenu:function(b,c){var d=a(this).data("contextMenuRoot");w.hide.call(d.$trigger,d,c&&c.force)},focusItem:function(b){b.stopPropagation();var b=a(this),c=b.data(),d=c.contextMenu,
c=c.contextMenuRoot;b.addClass("hover").siblings(".hover").trigger("contextmenu:blur");d.$selected=c.$selected=b;d.$node&&c.positionSubmenu.call(d.$node,d.$menu)},blurItem:function(b){b.stopPropagation();var b=a(this),c=b.data().contextMenu;b.removeClass("hover");c.$selected=null}},w={show:function(b,c,e){var f=a(this),g={};a("#context-menu-layer").trigger("mousedown");b.$trigger=f;if(b.events.show.call(f,b)===!1)d=null;else{w.update.call(f,b);b.position.call(f,b,c,e);if(b.zIndex)g.zIndex=o(f)+b.zIndex;
w.layer.call(b.$menu,b,g.zIndex);b.$menu.find("ul").css("zIndex",g.zIndex+1);b.$menu.css(g)[b.animation.show](b.animation.duration,function(){f.trigger("contextmenu:visible")});f.data("contextMenu",b).addClass("context-menu-active");a(document).off("keydown.contextMenu").on("keydown.contextMenu",k.key);if(b.autoHide)a(document).on("mousemove.contextMenuAutoHide",function(a){var c=f.offset();c.right=c.left+f.outerWidth();c.bottom=c.top+f.outerHeight();b.$layer&&!b.hovering&&(!(a.pageX>=c.left&&a.pageX<=
...
"").prop("checked",!!f.selected).prependTo(o);break;case "select":h=a('<select name="">').attr("name","context-menu-input-"+b).appendTo(o);f.options&&(a.each(f.options,function(b,c){a("<option></option>").val(b).text(c).appendTo(h)}),h.val(f.selected));break;case "sub":a("<span></span>").html(f._name||f.name).appendTo(g);f.appendTo=f.$node;w.create(f,e);g.data("contextMenu",f).addClass("context-menu-submenu");f.callback=null;break;case "html":a(f.html).appendTo(g);break;default:a.each([d,e],function(c,
...
document.body)},resize:function(b,c){b.css({position:"absolute",display:"block"});b.data("width",Math.ceil(b.width())+1);b.css({position:"static",minWidth:"0px",maxWidth:"100000px"});b.find("> li > ul").each(function(){w.resize(a(this),!0)});c||b.find("ul").andSelf().css({position:"",display:"",minWidth:"",maxWidth:""}).width(function(){return a(this).data("width")})},update:function(c,d){var e=this;d===b&&(d=c,w.resize(c.$menu));c.$menu.children().each(function(){var b=a(this),f=b.data("contextMenuKey"),
g=c.items[f],f=a.isFunction(g.disabled)&&g.disabled.call(e,f,d)||g.disabled===!0;b[f?"addClass":"removeClass"]("disabled");if(g.type)switch(b.find("input, select, textarea").prop("disabled",f),g.type){case "text":case "textarea":g.$input.val(g.value||"");break;case "checkbox":case "radio":g.$input.val(g.value||"").prop("checked",!!g.selected);break;case "select":g.$input.val(g.selected||"")}g.$menu&&w.update.call(e,g,d)})},layer:function(b,c){var d=b.$layer=a('<div id="context-menu-layer" style="position:fixed; z-index:'+
...
e.context=o.get(0),h=e.context!==document);switch(c){case "create":if(!e.selector)throw Error("No selector specified");if(e.selector.match(/.context-menu-(list|item|input)($|\s)/))throw Error('Cannot bind to selector "'+e.selector+'" as it contains a reserved className');if(!e.build&&(!e.items||a.isEmptyObject(e.items)))throw Error("No Items specified");n++;e.ns=".contextMenu"+n;if(!h)l[e.selector]=e.ns;r[e.ns]=e;if(!e.trigger)e.trigger="right";g||(f.on({"contextmenu:hide.contextMenu":k.hideMenu,
...
null}f.off(l[e.selector])}}else f.off(".contextMenu .contextMenuAutoHide"),a.each(r,function(b,c){a(c.context).off(c.ns)}),l={},r={},n=0,g=!1,a("#context-menu-layer, .context-menu-list").remove();break;case "html5":(!a.support.htmlCommand&&!a.support.htmlMenuitem||typeof d=="boolean"&&d)&&a('menu[type="context"]').each(function(){this.id&&a.contextMenu({selector:"[contextmenu="+this.id+"]",items:a.contextMenu.fromMenu(this)})}).css("display","none");break;default:throw Error('Unknown operation "'+
...
height:c?b.height():b.outerHeight()}}};a.fn.position=function(b){if(!b||!b.of)return s.apply(this,arguments);var b=a.extend({},b),k,j,z,u,t,x,B=a(b.of),C=a.position.getWithinInfo(b.within),D=a.position.getScrollInfo(C),q=(b.collision||"flip").split(" "),p={};x=f(B);if(B[0].preventDefault)b.at="left top";j=x.width;z=x.height;u=x.offset;t=a.extend({},u);a.each(["my","at"],function(){var a=(b[this]||"").split(" "),c,d;a.length===1&&(a=n.test(a[0])?a.concat(["center"]):l.test(a[0])?["center"].concat(a):
["center","center"]);a[0]=n.test(a[0])?a[0]:"center";a[1]=l.test(a[1])?a[1]:"center";c=r.exec(a[0]);d=r.exec(a[1]);p[this]=[c?c[0]:0,d?d[0]:0];b[this]=[v.exec(a[0])[0],v.exec(a[1])[0]]});q.length===1&&(q[1]=q[0]);b.at[0]==="right"?t.left+=j:b.at[0]==="center"&&(t.left+=j/2);b.at[1]==="bottom"?t.top+=z:b.at[1]==="center"&&(t.top+=z/2);k=c(p.at,j,z);t.left+=k[0];t.top+=k[1];return this.each(function(){var f,n,l=a(this),x=l.outerWidth(),r=l.outerHeight(),s=e(this,"marginLeft"),v=e(this,"marginTop"),
y=x+s+e(this,"marginRight")+D.width,G=r+v+e(this,"marginBottom")+D.height,A=a.extend({},t),F=c(p.my,l.outerWidth(),l.outerHeight());b.my[0]==="right"?A.left-=x:b.my[0]==="center"&&(A.left-=x/2);b.my[1]==="bottom"?A.top-=r:b.my[1]==="center"&&(A.top-=r/2);A.left+=F[0];A.top+=F[1];if(!a.support.offsetFractions)A.left=h(A.left),A.top=h(A.top);f={marginLeft:s,marginTop:v};a.each(["left","top"],function(c,d){if(a.ui.position[q[c]])a.ui.position[q[c]][d](A,{targetWidth:j,targetHeight:z,elemWidth:x,elemHeight:r,
collisionPosition:f,collisionWidth:y,collisionHeight:G,offset:[k[0]+F[0],k[1]+F[1]],my:b.my,at:b.at,within:C,elem:l})});b.using&&(n=function(a){var c=u.left-A.left,e=c+j-x,f=u.top-A.top,h=f+z-r,k={target:{element:B,left:u.left,top:u.top,width:j,height:z},element:{element:l,left:A.left,top:A.top,width:x,height:r},horizontal:e<0?"left":c>0?"right":"center",vertical:h<0?"top":f>0?"bottom":"middle"};if(j<x&&g(c+e)<j)k.horizontal="center";if(z<r&&g(f+h)<z)k.vertical="middle";k.important=d(g(c),g(e))>d(g(f),
g(h))?"horizontal":"vertical";b.using.call(this,a,k)});l.offset(a.extend(A,{using:n}))})};a.ui.position={fit:{left:function(a,b){var c=b.within,e=c.isWindow?c.scrollLeft:c.offset.left,f=c.width,g=a.left-b.collisionPosition.marginLeft,c=e-g,h=g+b.collisionWidth-f-e;b.collisionWidth>f?c>0&&h<=0?(e=a.left+c+b.collisionWidth-f-e,a.left+=c-e):a.left=h>0&&c<=0?e:c>h?e+f-b.collisionWidth:e:c>0?a.left+=c:h>0?a.left-=h:a.left=d(a.left-g,a.left)},top:function(a,b){var c=b.within,e=c.isWindow?c.scrollTop:c.offset.top,
